...
@Configuration
@MapperScan(basePackages = "com.rivergame.fvgm.dao.farmbigdata", sqlSessionTemplateRef = "farmBigDataSqlSessionTemplate")
public class DataSource5Config {
    @Bean(name = "farmBigDataDataSource")
    public DruidDataSource dataSource() {
        String prefix = "datasource_farm_bigdata_";
    ...
    @Bean(name = "farmBigDataTransactionManager")
    ...
    @Bean(name = "farmBigDataSqlSessionFactory")
    public SqlSessionFactoryBean mybatisSqlSessionFactory() {
        SqlSessionFactoryBean sqlSessionFactoryBean = new SqlSessionFactoryBean();
        sqlSessionFactoryBean.setDataSource(dataSource());
        PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        try {
            sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:/mapper/farmbigdata/*.xml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @Bean(name = "farmBigDataSqlSessionTemplate")
